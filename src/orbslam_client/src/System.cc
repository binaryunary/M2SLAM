...
//        Lmin = 1;
        ...
        mpCacher = new Cache( maxArea, Lmax, Lmin );
        ...
        mptCache = new thread(&ORB_SLAM2::Cache::run, mpCacher);
        ...
        mpViewer = new Viewer(this, mpFrameDrawer, mpMapDrawer, mpTracker, strSettingsFile, maxArea, Lmax, Lmin);
        if (bUseViewer)
    ...
    void System::Shutdown() {
        ...
        while (!mpLocalMapper->isFinished() || !mpLoopCloser->isFinished() ||
            ...
            cout << mpLocalMapper->isFinished() << " " << mpLoopCloser->isFinished()
                 << " " <<  mpLoopCloser->isRunningGBA() << endl;
            usleep(1000000);
        }

        mpCacher->outputKeyframePose();
